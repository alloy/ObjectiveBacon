...
(global import
  (macro-0 _
    (set __url ((NSBundle mainBundle) URLForResource:((margs car) stringValue) withExtension:"bridgesupport"))
    (puts __url)
    (NuBridgeSupport importMetadata:__url intoDictionary:BridgeSupport)
  )
)
